---
layout: post
title: 【游戏】Linux GTK游戏 -- 扫雷（Gtk+2.0）
---

之前做了一个字符界面下的扫雷. 自己倒是玩的不亦乐乎, 不过用户体验太差@@, 囧...

"重新开始"的功能没有做. 懒...

这次的代码基于Gtk+2.0, 如果自己编译的话, 还要装下Gtk库.

先上两张图:

![mine_gtk_001](/assets/img/mine_gtk_001.png)
![mine_gtk_002](/assets/img/mine_gtk_002.png)
